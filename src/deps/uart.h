...
#define UART_H
/************************************************************************
Title:    Interrupt UART library with receive/transmitAll circular buffers
 ...
 * 
 *  @brief Interrupt UART library using the built-in UART with transmitAll and receive circular buffers.
 *
 *  This library can be used to transmitAll and receive data through the built in UART.
 *
...
/** @brief  Size of the circular transmitAll buffer, must be power of 2
 *
 *  You may need to adapt this constant to your target and your application by adding 
